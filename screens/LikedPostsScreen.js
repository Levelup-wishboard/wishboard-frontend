  ...
  useEffect(() => {
    const fetchLikedPosts = async () => {
      try {
        ...
        const res = await axios.get('http://3.39.187.114:8080/users/myLike', {
          headers: {
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerRight}>
          <Ionicons
            ...
            onPress={() => navigation.navigate('mypage', { screen: 'Alam' })}
          />
          <Ionicons
            name="person-outline"
            size={20}
            color="#FBA834"
            onPress={() => navigation.navigate('mypage', { screen: 'MyPageScreen' })}
          />
        </View>
      </View>
